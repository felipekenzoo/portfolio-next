...
export default function Hero() {
    return (
        <section className="relative flex flex-col w-full min-h-dvh items-center justify-start pt-32 md:pt-32 text-center overflow-hidden bg-zinc-900">
            ...
            <div className="relative z-10 flex flex-col items-center w-full px-4 gap-6">
                ...
                <p className="text-lg md:text-xl text-zinc-200 font-light max-w-2xl leading-relaxed drop-shadow-md">
                    ...
                    Foco na experiência do usuário em cada etapa.
                </p>
