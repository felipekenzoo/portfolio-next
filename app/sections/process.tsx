...
export default function Process() {
  return (
    <section
      className="flex flex-col py-16 md:py-20 px-6 md:px-12 lg:px-28 bg-zinc-950"
      id="process"
    >
      <div className="max-w-7xl mx-auto w-full">
        <h2 className="text-zinc-50/90 text-3xl md:text-4xl lg:text-5xl font-medium">
          Como posso te ajudar?
        </h2>
        <p className="text-zinc-400 py-4 text-base md:text-lg">
      ...
      <div className="flex justify-between max-w-7xl mx-auto w-full pt-10 mt-10 border-t border-zinc-800/80 pb-6 md:pb-0 flex-col md:flex-row gap-4 md:gap-0">
        <h6 className="text-md">
          Pensando no usuário em cada etapa do processo
          <span className="text-md font-light text-zinc-400">
            {" "}
            • User Centered Design
          </span>
        </h6>
        <div>
          <h6 className="text-md w-fit pt-10 text-zinc-200/80 md:w-xl md:pt-0">
