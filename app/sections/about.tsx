...
export default function About() {
  return (
    <section
      className="py-16 md:py-20 px-6 md:px-12 lg:px-28 bg-zinc-50 justify-center flex flex-col items-center"
      id="about"
    >
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-center max-w-7xl">
        <div className="w-full lg:w-auto flex justify-center lg:justify-start shrink-0">
          <div>
            <Image
              ...
              width={500}
              height={500}
              className="rounded-4xl mb-8 border border-zinc-200 w-full max-w-md lg:max-w-lg"
              priority
              quality={100}
            />
          </div>
        ...
        <div className="w-full lg:max-w-xl">
          <p className="text-zinc-700 text-base md:text-lg">Muito prazer 👋🏻</p>
          <div className="my-2.5">
            <h2 className="text-4xl md:text-5xl mb-4 text-zinc-950 font-semibold">
              Felipe Sunakozawa
            </h2>
            <h3 className="text-zinc-800 text-lg md:text-xl mb-6">
